...
2. Naming conventions:
    ...
    * Branch names should follow the PROJECT-ISSUE convention with an optional short description. e.g. `YSP-60-contributing-guidelines`
    * Commit messages should follow the PROJECT-ISSUE MESSAGE convention. e.g. `YSP-60 Add missing contributing guidelines`
